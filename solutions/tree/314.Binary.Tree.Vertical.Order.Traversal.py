...
#             return
#
#         # tuple of (coordinate, order of entering the heap, val).
    ...
    def verticalOrder(self, root):
        ...
        while queue:
            ...
            while size > 0:
                ...
                # the queue (FIFO) guarantee the same column nodes from left to right
        ...
        ans = []
        skeys = sorted(colmap.keys())
        for key in skeys:
            ans.append(colmap[key])
        return ans
