...
class Solution:
    def reachableNodes(self, edges, M, N):
        ...
        # use as a max pq to store <# moves, node>
        pq = []
        # the original nodes visited to the remaining moves.
        node2move = dict()
